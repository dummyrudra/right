...
=======
$(document).ready(function() {
>>>>>>> 2f2a9ff708951327a85b4704877b05d48ec03c26
...
$("#kt_daterangepicker_3 , #kt_daterangepicker_4 ,#kt_daterangepicker_1 , #kt_daterangepicker_2 , #kt_daterangepicker_5 ,#kt_daterangepicker_6").daterangepicker({
...
$(document).ready(function(){
       ...
       $("#kt_accordion_2_header_2").click(function(){
        ...
        if ( $("#roadmap-acc-1").hasClass('d-none')) {
            ...
            $("#logout-btn").toggleClass('justify-content-center');
